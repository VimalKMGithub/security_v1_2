...
@Converter
public class EmailConverter extends AbstractConverter<String> {
    public EmailConverter(AESUtilFactory aesUtilFactory) {
        super(aesUtilFactory, AESOperationType.EMAIL);
    }
